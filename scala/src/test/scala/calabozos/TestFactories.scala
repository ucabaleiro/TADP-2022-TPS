...
object TestFactories {
  ...
  def unLadron(salud: Double = 1,
    ...
    Heroe(salud, nivel, Ladron(fuerzaBase, velocidadBase, habilidadBase), criterio, personalidad)
  ...
  def unMago(salud: Double = 1,
             ...
             criterio: Criterio = Heroico,
             personalidad: Personalidad = Loquito): Heroe =
    Heroe(salud, nivel, Mago(fuerzaBase, velocidadBase, aprendizaje match { case null => List(); case _ => List(aprendizaje) }), criterio, personalidad)
  ...
  def unGuerrero(salud: Double = 1,
                 ...
                 criterio: Criterio = Heroico,
                 personalidad: Personalidad = Loquito): Heroe =
    Heroe(salud, nivel, Guerrero(fuerzaBase, velocidadBase), criterio, personalidad)
